...
<script runat="server">
    ...
    public override bool CheckAuthentication()
    {
        ...
        //if (Session["Username_Web_config"] != null)
    ...
    public override void SetConfig()
    {
        ...
        acl.FileRename = true;
        acl.FileDelete = true;
        //if (Convert.ToString(Session["Roles"]) == "Admin")
        //{
        //    acl.Role = "*";
        //    acl.ResourceType = "*";
        //    acl.Folder = "/";
        ...
        //    acl.FileDelete = true;
        //}
        //else if (Convert.ToString(Session["Roles"]) == "Personnel")
        //{
        //    acl.Role = "*";
        //    acl.ResourceType = "*";
        //    acl.Folder = "/";
        ...
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "bmp", "gif", "jpeg", "jpg", "png","doc","docx","xlsx" };
        type.DeniedExtensions = new string[] { };
